 ...
 * 301 về bản VI ngay trong next.config — luật đó chạy TRƯỚC proxy nên tới đây
 * pathname thực tế chỉ còn /vi hoặc không tiền tố.
 *
...
export function proxy(request: NextRequest) {
  ...
  // tiếp về /<path> — hai nhịp cho một lần chuyển (đo prod 25/8: /keo?lang=th ->

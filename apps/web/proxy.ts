...
export const config = {
  matcher: [
    "/((?!_next/static|_next/image|favicon\\.ico|icons|images|sw\\.js|manifest\\.webmanifest|manifest|api|robots\\.txt|sitemap\\.xml|news-sitemap\\.xml|og-home\\.png|f29229590981931e9c15bc0efdb0dff0\\.txt).*)",
  ],
};

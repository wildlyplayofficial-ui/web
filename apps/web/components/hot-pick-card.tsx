...
export function HotPickCard({
  ...
  return (
    <article className="group grid overflow-hidden rounded-card border border-brand/40 bg-card shadow-raised md:grid-cols-2">
      {/* Left: predicted scoreboard */}
      <div className="relative flex flex-col justify-center gap-4 border-b border-brand/20 bg-brand-dim/40 p-6 md:border-b-0 md:border-r md:p-8">

...
/**
 * Guide/calculator OG card (1200×630) — branded green card + một dòng "concept"
 * riêng theo chủ đề (biểu đồ khái niệm ở dạng chữ).
 *
 * KHÔNG dùng ảnh cầu thủ ở đây (Peter bắt 25/8). Mọi bài hướng dẫn xài chung MỘT
 * ảnh cầu thủ cố định, nên bài "Tài Xỉu là gì" ra thẻ chia sẻ có Haaland áo Man
 * City — người thấy tưởng bài viết về Man City, bấm vào hụt. Bài dạy kiến thức
 * thì để thẻ chữ, đúng nội dung hơn.
 * Các thẻ khác (trang chủ, editorial, record...) vẫn giữ ảnh cầu thủ.

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  // hreflang chỉ khai bản tiếng Việt (Peter chốt 25/8). Bảng `posts` vẫn giữ hàng
  // en/th/es cho công cụ dịch trong admin, nên getPostLangs trả về cả 4 — khai
  // ra là trỏ Google vào /en /th /es đã 301 từ 23/8, tự dựng chuỗi chuyển hướng
  // cho chính mình. Đo trên prod 25/8: 690 thẻ hreflang hỏng trên 237 trang.

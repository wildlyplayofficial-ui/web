    ...
    <div className="mx-auto max-w-[800px] px-5 py-12">
      ...
      <section className="mt-8 border-t border-line pt-8">
        ...
        <div className="mt-4 flex flex-wrap gap-4">
          <a href="https://t.me/banhbong" target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-brand hover:underline">Telegram</a>
          ...
          <a href="https://www.facebook.com/banhbong.net" target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-brand hover:underline">Facebook</a>
        </div>
      </section>
    </div>
  );

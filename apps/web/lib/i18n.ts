...
export interface Dict {
  ...
  scout: {
    heading: string;
    /** Chỉ TÊN nhân vật, không kèm tiêu đề khối — dùng khi đứng cạnh tên
     *  Chú Tám Banh trong cùng một băng (băng Bảng Dự Đoán ở trang chủ). */
    name: string;
    ...
    badge: string;
    noPlay: string;
    /** Bản KHÔNG kèm tên nhân vật — dùng khi tên đã in ngay bên cạnh (băng Bảng
     *  Dự Đoán gộp ở trang chủ), nếu không sẽ đọc thành "Trợ lý AI  Trợ lý AI —…". */
    noPlayShort: string;
    disclosure: string;
  };
  watching: {
...
const en: Dict = {
  ...
  standings: {
    ...
    roundLabel: "Matchday {n}",
    provisionalTime: "Kick-off times not announced yet — date is set",
    localTimeNote: "*All times shown in your local time",
...
const vi: Dict = {
  ...
  board: {
    ...
    seoDescription: "Nhận định bóng đá miễn phí hằng ngày với thành tích công khai — mọi nhận định thắng lẫn thua đều đăng vĩnh viễn. Chú Tám Banh chỉ đưa nhận định khi có lợi thế thật sự. Theo dõi nhận định hôm nay, trận bỏ qua và danh sách theo dõi trên Premier League, La Liga, Serie A và nhiều giải khác.",
    formTitle: "Phong độ gần đây",
    last30: "30 ngày qua",
    emptyTitle: "Hôm nay không có nhận định.",
    emptyBody:
      "Chú Tám Banh chỉ chơi khi thấy lợi thế thật sự. Không nhận định gượng ép, không câu kéo — quay lại ngày mai hoặc theo dõi Telegram để nhận dự đoán tiếp theo.",
  ...
  archive: {
    ...
    unitsNote:
      "Huy hiệu tính thắng nửa là THẮNG, thua nửa là THUA. Lãi/Lỗ unit giữ nguyên cách tính chấp châu Á thực tế.",
  },
  stats: {
    title: "Thống Kê",
    subtitle: "Toàn bộ thành tích, bóc tách theo giải đấu, loại dự đoán và thời gian. Tính cả dự đoán thua.",
    byLeague: "Theo giải đấu",
    byMarket: "Theo loại dự đoán",
    league: "Giải đấu",
    market: "Loại dự đoán",
    settled: "Đã kết sổ",
    roi: "ROI",
  ...
  calculators: {
    title: "Công Cụ Tính",
    subtitle: "Công cụ toán phân tích miễn phí — loại margin thị trường, chuyển đổi tỷ lệ, và tính mức tham gia theo Kelly.",
    ...
    oddsConverter: "Chuyển Đổi Tỷ Lệ",
    oddsConverterDesc: "Chuyển đổi giữa Thập phân, Phân số, Mỹ, Malay, Hồng Kông, Indonesia và Xác suất ngầm định.",
    kelly: "Phương Pháp Kelly",
    kellyDesc: "Tính mức tham gia tối ưu dựa trên lợi thế. Mặc định Kelly phân số cho quản lý vốn an toàn.",
    deVigCta: "Tìm hiểu lý thuyết đằng sau de-vigging",
    oddsConverterCta: "Tìm hiểu chi tiết 7 định dạng tỷ lệ",
    kellyCta: "Tìm hiểu lý thuyết đằng sau phương pháp Kelly",
  },
  pick: {
  ...
  play: {
    ...
    pickedAt: "Chốt dự đoán khi tỉ số",
    market: "Loại dự đoán",
    line: "Mốc dự đoán",
    result: "Kết quả",
    rawOutcome: "Kết quả dự đoán gốc",
    thesis: "Nhận định",
    closing: "Tỷ lệ cuối",
    clvNote: "CLV = giá trị so với tỷ lệ cuối — dương nghĩa là dự đoán thắng được thị trường.",
  ...
  share: {
    title: "Chia sẻ nhận định này:",
    copy: "Sao chép link",
    copied: "Đã sao chép!",
    more: "Khác…",
  },
  crowd: {
    title: "Cộng đồng vs Chú Tám Banh",
    followersWon: "Người cùng dự đoán thắng ({units} mỗi 1u)",
    followersLost: "Người cùng dự đoán thua",
  },
  badge: {
    upcoming: "SẮP ĐÁ",
    live: "LIVE",
  ...
  scout: {
    ...
    noPlayShort: "kh\u00f4ng c\u00f3 k\u00e8o ph\u1ee5 h\u00f4m nay",
    disclosure: "Trợ lý AI \u2014 nh\u00e2n v\u1eadt gi\u1ea3 t\u01b0\u1edfng, AI-operated, c\u1ee7a banhbong.net \u00b7 \u0111\u1ed9 tin th\u1ea5p h\u01a1n \u00b7 s\u1ed5 ri\u00eang",
  },
  watching: {
    title: "Chú Tám Banh \u0111ang theo d\u00f5i",
    titlePast: "Chú Tám Banh \u0111\u00e3 theo d\u00f5i",
    note: "Ghi ch\u00fa t\u1eeb Chú Tám Banh",
  ...
  match: {
    ...
    curatorWatch: "Chú Tám Banh \u0111ang theo d\u00f5i",
    curatorPick: "K\u00e8o c\u1ee7a Chú Tám Banh",
  ...
  standings: {
    ...
    roundLabel: "Vòng {n}",
    provisionalTime: "Chưa công bố giờ đá — ngày thì đã chốt",
    localTimeNote: "*Giờ hiển thị theo múi giờ máy của bạn",
    prevRound: "Vòng trước",
    nextRound: "Vòng sau",
  },
};
...
const th: Dict = {
  ...
  scout: {
    ...
    noPlayShort: "\u0e44\u0e21\u0e48\u0e21\u0e35\u0e17\u0e35\u0e40\u0e14\u0e47\u0e14\u0e2a\u0e33\u0e23\u0e2d\u0e07\u0e27\u0e31\u0e19\u0e19\u0e35\u0e49",
  ...
  standings: {
    ...
    roundLabel: "นัดที่ {n}",
    provisionalTime: "ยังไม่ประกาศเวลาแข่ง — วันที่ยืนยันแล้ว",
    localTimeNote: "*เวลาทั้งหมดแสดงตามเขตเวลาของคุณ",
    prevRound: "นัดก่อนหน้า",
    nextRound: "นัดถัดไป",
  },
};
...
const es: Dict = {
  ...
  scout: {
    ...
    noPlayShort: "sin pick alternativo hoy",
  ...
  standings: {
    ...
    roundLabel: "Jornada {n}",
    provisionalTime: "Horario sin anunciar — la fecha ya está fijada",
    localTimeNote: "*Horarios en tu zona horaria local",
    prevRound: "Jornada anterior",

...
const TRANSLATE_GLOSSARY: Record<string, string> = {
  Vietnamese: 'thesis/read=nhận định (NOT luận án/luận văn), board=thị trường, coin-flip=may rủi/5-5, Glass half-full=Lạc quan, stake=mức tham gia, honest call=nhận định thẳng thắn, crow/brag=khoe khoang, the Curator/Curator=Chú Tám Banh, the Scout/Scout=Trợ lý AI (never leave Curator/Scout/Admin in Vietnamese)',

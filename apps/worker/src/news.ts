...
import { callClaude, computeRecord, disclosureBlock, isPlaceholderTeam, sectionSpec, slugify, splitLangSections, VI_LEXICON_RULE, CHU_TAM_VOICE, type SettledRecord } from './recap';

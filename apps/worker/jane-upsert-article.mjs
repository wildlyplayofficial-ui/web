...
// Tên tác giả lấy từ hằng số dùng chung, không gõ tay ở đây.
...
const row = {
  ...
  // Peter chốt 15/9: nhận định → Chú Tám Banh; bài "Lịch thi đấu…" là tin lịch → Pete Nguyễn.
  byline: /^Lịch thi đấu/i.test(title) ? BYLINES.pete : BYLINES.chuTam, author_type: 'desk_ai', title, body, status,
};
